...
namespace ManageWO
{
    public partial class PTHKN : System.Web.UI.Page
    {
        ...
        protected void tableKN_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "DownloadKN")
            {
                try
                {
                    ...
                    string conString2 = ConfigurationManager.ConnectionStrings["material"].ConnectionString;
                    ...
                    sqlCommand00.Parameters.Add("@WorkOrder", SqlDbType.VarChar, 50).Value = row.Cells[1].Text.ToString();
                    ...
                    date = date.Replace('/', '_');
                    string pathFile00 = HttpContext.Current.Server.MapPath(@"~/Files/" + "Kitting Note PTH " + Session["wo"] + " " + Session["model"] + "  " + date + ".xlsx");
                    ...
                    document00.SetCellValue("A2", "KITTING NOTE PTH UPLOADED");
                    ...
                    Response.AddHeader("Content-Disposition", "attachment; filename=" + "Kitting Note PTH " + WOrowData + ".xlsx");
            ...
            else if (e.CommandName == "DeleteKN")
            {
                try
                {
                    ...
                    string conString3 = ConfigurationManager.ConnectionStrings["material"].ConnectionString;
                    ...
                    alertText.Text = "Kitting Note PTH Deleted Succesfully";
                ...
                catch (Exception ex)
                {
                    ...
                    AlertIcon.Attributes.Add("class", " bi bi-info-circle-fill");
                    alert.Attributes.Add("class", " alert alert-danger  alert-dismissible ");
                    alertText.Text = "Something went wrong" + error.ToString();
                    ClientScript.RegisterStartupScript(GetType(), "HideLabel", "<script type=\"text/javascript\">setTimeout(\"document.getElementById('" + alert.ClientID + "').style.display='none'\",4000)</script>");
                    BindGridView();
                }
            }
        ...
        protected void tableKN_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //    e.Row.Cells[3].Text = "Commit WO";
            //    e.Row.Cells[4].Text = "Actions";
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            if (fuData.PostedFile != null)
            {
                if (fuData.PostedFile.FileName != "")
                {
                    try
                    {
                        string filename = Server.MapPath("~/UploadFile/KN_PTH/" + fuData.FileName);
                        ...
                        {
                            OleDbCommand oleDbCommand = new OleDbCommand("SELECT * FROM [Hoja1$] WHERE WorkOrder <> '' and  Flag ='N:General Item' And Standard QPA", connection);
                            connection.Open();
                            ...
                            AlertIcon.Attributes.Add("class", "bi bi-database-fill");
                            alert.Attributes.Add("class", " alert alert-info  alert-dismissible ");
                            alertText.Text = "Kitting Note PTH Uploaded succesfully";
        ...
        public void BindGridView()
        {
            ...
            {
                SqlCommand sqlCommand = new SqlCommand("GetLastWOPTH2", connection);
        ...
        {
            using (SqlConnection connection1 = new SqlConnection(ConfigurationManager.ConnectionStrings["pth"].ConnectionString))
            {
