...
namespace ManageWO
{
    public partial class edit_smtkn : System.Web.UI.Page
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["smt"].ConnectionString);
        ...
        private void BindNPGrid_Sp()
        {
            SqlDataAdapter adp = new SqlDataAdapter();
            DataTable dt = new DataTable();
            try
            {
                adp = new SqlDataAdapter("BindNPGrid_Sp", con);
        ...
        protected void myTable_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            sqlCommand4.Parameters.Add("@KNQty", SqlDbType.Int).Value = qty;
        ...
        protected void myTable_Sorting(object sender, GridViewSortEventArgs e)
        {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmdSP = new SqlCommand("AddPartnumberKittingNoteSMT", connectionDBsmt);
