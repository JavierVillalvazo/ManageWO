<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchAlternsWO.aspx.cs" Inherits="ManageWO.SearchAlternsWO" %>
...
<head runat="server">
    ...
    <title>SMT - Search alterns WO</title>
</head>
<body>
                ...
                <div class="collapse navbar-collapse mx-auto" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        <li class="nav-item active fw-bold ">
                            <a class="nav-link text-white" href="#" title="">Search alterns</a>
                    </ul>
