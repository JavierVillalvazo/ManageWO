<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="true" CodeBehind="smtWO.aspx.cs" Inherits="ManageWO.smtWO" %>
...
<head runat="server">
    ...
    <title>SMT - Work Order Management</title>
</head>
<body>
        ...
        <div class="container mt-3 mx-auto">
            ...
            <div class="form-group row">
                <div class="form-group col-md-4">
                    ...
                    <asp:TextBox runat="server" class="form-control" ID="inputWorkorder" aria-describedby="basic-addon1" placeholder="M5107-YYMMXXXX" OnTextChanged="inputWorkorder_TextChanged"></asp:TextBox>
                ...
                <div class="form-group col-md-4">
                    ...
                    <asp:TextBox runat="server" TextMode="Number" AutoCompleteType="Disabled" AutoPostBack="true" class="form-control" ID="inputQty"></asp:TextBox>
                ...
                <div class="form-group col-md-4">
                    ...
                    <asp:TextBox runat="server" type="text" class="form-control" ID="inputModel"></asp:TextBox>
            ...
            <div class="form-group  row ">
                <div class="form-group col-md-6">
                    ...
                    <asp:TextBox runat="server" type="text" class="form-control" ID="inputFirstQR" placeholder="First QR printed"></asp:TextBox>
                </div>
                <div class="form-group col-md-6">
                    <asp:Label runat="server" CssClass="fw-bold  ">Last QR</asp:Label>
                    <asp:TextBox runat="server" class="form-control" ID="inputLastQR" placeholder="Last QR printed"></asp:TextBox>
                </div>
            </div>
            <div class="  form-group mt-3 ">
                <asp:LinkButton ID="NewBtn" runat="server" class=" rounded-3 btn btn-dark " OnClick="NewBtn_Click" Visible="false"><i class="bi bi-file-earmark-plus"></i> Create new work order</asp:LinkButton>
                ...
                <div class="rounded table-responsive ">
                    <asp:GridView runat="server" ID="myTable" OnRowDataBound="myTable_RowDataBound" OnRowCommand="myTable_RowCommand" HeaderStyle-HorizontalAlign="Center" OnPageIndexChanging="myTable_PageIndexChanging" OnSelectedIndexChanged="myTable_SelectedIndexChanged" CssClass="table" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false" DataKeyNames="WorkOrder" AllowPaging="false" BorderStyle="None">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="WorkOrder" HeaderText="WorkOrder" ReadOnly="True" SortExpression="WorkOrder" ItemStyle-Width="12%" />
