<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_smtkn.aspx.cs" Inherits="ManageWO.edit_smtkn" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <title>Edit Kitting Note - SMT</title>
</head>
<body class="">
            ...
            <div runat="server" id="divFilter" visible="true" class="row d-flex justify-content-end mt-2">
                <div class="col-md-6 text-md-end mb-2">
                    <asp:LinkButton runat="server" ID="addModal" Font-Size="Small"  data-bs-target="#exampleModalToggle" data-bs-toggle="modal" CssClass="btn btn-primary " Visible="true">
                     ...
                     <asp:LinkButton runat="server" ID="btnUploadKN" Font-Size="Small"   CssClass="btn btn-dark  " Visible="true" PostBackUrl="~/SMTKN.aspx">
                ...
                <div class="col-md-4 col-lg-3 mb-2 ">
                    <div class="input-group ">
                        <asp:TextBox runat="server" Font-Size="Small" TextMode="Search" CssClass="form-control text-start" Visible="true" ID="txtSearch"  aria-describedby="basic-addon1" placeholder="All" AutoCompleteType="Disabled"></asp:TextBox>
   ...
   <i class="bi bi-x-circle"></i>
            ...
            <div class="row mt-1  ">
                    <asp:GridView runat="server" ID="myTable" OnRowUpdating="myTable_RowUpdating"
                        ...
                        DataKeyNames="WorkOrder" AllowPaging="true" data-bs-theme="light" Height="60%" PageSize="20">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Qty to issue" ItemStyle-Width="6%" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-body-secondary fw-bold">
                                <ItemTemplate>
                                    <asp:Label ID="lblKNQty" runat="server" Text='<%# Eval("KNQty") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox BackColor="#ffdd73" runat="server" ID="txtKNQty" Font-Size="Small" Text='<%# Eval("KNQty") %>' CssClass="form-control fw-bold text-center  " AutoCompleteType="Disabled"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                        ...
                        <PagerSettings Mode="NextPreviousFirstLast" PageButtonCount="10" FirstPageText="First" LastPageText="Last" />
                    </asp:GridView>
                </div>
            ...
            <div class="modal-dialog modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-dark">
                        ...
                        <asp:Label runat="server" CssClass=" rounded-pill bg-primary px-3 fs-6 text-white" Text="Kitting Note SMT" ID="dataWO"></asp:Label>
