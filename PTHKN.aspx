<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PTHKN.aspx.cs" Inherits="ManageWO.PTHKN" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="collapse navbar-collapse mx-auto" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        <li class="nav-item active fw-bold ">
                            <a class="nav-link text-white" href="#" title="CREATE, UPDATE, DELETE WORK ORDER PTH">WO</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" title="Upload, delete, and update Kitting note pth" href="./smtkn.aspx">KN</a>
                        </li>
        ...
        <div class="container-fluid mt-3 mx-auto  ">
            <div class="container ">
                ...
                <%--             <h2 style="text-align: center;" class="">KITTING NOTE PTH</h2>
                <hr />--%>
                        ...
                        <div class="modal-dialog modal-dialog modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header bg-dark">
                                    <label class="modal-title fs-5 text-white fw-bold" id="exampleModalToggleLabel">Kitting note PTH        - Excel</label>
                ...
                <div class="form-row ">
                    <div class="table-responsive">
                        <asp:GridView runat="server" ID="tableKN" HeaderStyle-BackColor="#ebebeb" OnPageIndexChanging="tableKN_PageIndexChanging" OnSelectedIndexChanged="tableKN_SelectedIndexChanged" OnRowCommand="tableKN_RowCommand" OnSelectedIndexChanging="tableKN_SelectedIndexChanging" CssClass="table table-hover table-responsive" ShowHeaderWhenEmpty="true" BorderStyle="None" AutoGenerateColumns="false" OnRowDataBound="tableKN_RowDataBound" DataKeyNames="WorkOrder" AllowPaging="true" HorizontalAlign="Center" GridLines="Horizontal" Width="100%" Height="60%" PageSize="10">
                            ...
                            <Columns>
                                <asp:ButtonField ButtonType="image" ImageUrl="./Resources/images/icons/download2.png" Text="DOWNLOAD" CommandName="DownloadKN" HeaderText="Download" ItemStyle-Width="5%" />
                                ...
                                <asp:BoundField DataField="QtyCommit" HeaderText="QtyCommit" SortExpression="QtyCommit">
                                    <ItemStyle Width="20%"></ItemStyle>
                                </asp:BoundField>
                                ...
                                <%--<asp:TemplateField HeaderText="Actions" ItemStyle-Width="15%" ItemStyle-Height="5px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton CommandName="DeleteKN" runat="server" data-bs-target="#myModal" data-bs-toggle="modal" CssClass="btn btn-lg  btn-outline-danger   border border-0" ToolTip="Delete current row" OnClientClick="return window.confirm('Do you want to delete the selected record?');"> <i class="bi bi-trash3-fill"></i></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                            </Columns>
