...
namespace ManageWO
{
    public partial class SearchSmtWO : System.Web.UI.Page
    {
        ...
        public void DataFilter()
        {
            ...
            {
                SqlCommand sqlCommand1 = new SqlCommand("GetWOSMTFilterLikeSearch", connection1);
        ...
        {
            if (e.CommandName == "viewAlterns")
            {
                try
                {
                    int index2 = Convert.ToInt32(e.CommandArgument);
                    GridViewRow row2 = myTable.Rows[index2];
                    Session["WorkOrder"] = row2.Cells[0].Text.ToString();
                    //Response.Write("<script>javascript:window.open('searchalterns.aspx');");
                    Response.Redirect("~/SearchAlternsWO.aspx");
                }
                catch(Exception _e) { 
        ...
        private void BindGridView()
        {
            ...
            {
                SqlCommand sqlCommand = new SqlCommand("GetLast100WOSMTSearch", connection);
